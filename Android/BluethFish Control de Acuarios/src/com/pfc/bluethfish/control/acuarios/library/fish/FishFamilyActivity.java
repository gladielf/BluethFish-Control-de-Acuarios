...
public class FishFamilyActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState){
		...
		String order;
		String intentvalor = getIntent().getStringExtra("order");
		...
		if (intentvalor != null){
			...
			SharedPreferences prefs = getSharedPreferences("MyPreferences",FishFamilyActivity.MODE_PRIVATE); 
        ...
        actionBar.setTitle(getString(R.string.action_bar_fish_library_family) + " " + order);
		...
		gridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
				...
				Intent intent = new Intent(FishFamilyActivity.this,FishListActivity.class);
				intent.putExtra("family", adapter.getItem(position));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
		...
		case android.R.id.home:
			NavUtils.navigateUpTo(this, new Intent(this, FishOrderActivity.class));
            return true;
		default:
	...
	public void fillGrid(String order) {
    	...
    	dbAdapter.open();
    	Cursor cursor= dbAdapter.getCursorFreshwaterFishFamily(order);
