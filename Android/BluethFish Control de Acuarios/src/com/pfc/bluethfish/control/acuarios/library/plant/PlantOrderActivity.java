...
public class PlantOrderActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState){
        ...
        actionBar.setTitle(R.string.action_bar_plant_library_order);
		...
		gridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
				...
				Intent intent = new Intent(PlantOrderActivity.this,PlantFamilyActivity.class);
				intent.putExtra("PlantOrder", adapter.getItem(position));
	...
	public void fillGrid() {
    	...
    	dbAdapter.open();
    	Cursor cursor= dbAdapter.getCursorFreshwaterPlantOrder();
